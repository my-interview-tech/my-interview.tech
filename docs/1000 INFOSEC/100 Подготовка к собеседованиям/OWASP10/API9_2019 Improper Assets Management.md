---
title: API9-2019 Improper Assets Management
draft: true
tags:
  - infosec
  - OWASP
...
**API9:2019** **Improper** **Assets** **Management** (Некорректное управление ресурсами API)

“_API, как правило, предоставляют больше_ _endpoints, чем обычные веб-приложения, поэтому важно своевременно проверять и актуализировать документацию. Инвентаризация хостов и развернутых версий_ _API также играют важную роль в устранении таких проблем, как устаревшие версии_ _API и открытые_ _endpoints для отладки_.”

API может быть уязвимым, если назначение API хоста неясно, а также нет четких ответов на следующие вопросы:
...
- Создавайте документацию автоматически, используя общедоступные стандарты (swagger, etc.) Включайте создание документации в CI/CD.
