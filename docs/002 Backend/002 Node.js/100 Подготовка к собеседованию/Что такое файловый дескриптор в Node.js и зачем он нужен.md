...
tags:
  ...
  - "#ввод-вывод"
info:
  - "[Документация по файловым дескрипторам в Node.js](https://nodejs.org/api/fs.html#file-descriptors)"
  - "[Руководство по работе с файлами в Node.js](https://nodejs.org/api/fs.html#fs_file_system)"
  - "[Системные вызовы для работы с файлами](https://man7.org/linux/man-pages/man2/open.2.html)"
---
...
fs.open("example.txt", "r", (err, fd) => {
  ...
  console.log("Файловый дескриптор:", fd)
