...
tags:
  ...
  - "#аутентификация"
info:
  - "[Документация ngrok по безопасности](https://ngrok.com/docs/secure-tunnels/)"
  - "[Руководство по безопасности сетевых туннелей](https://www.cloudflare.com/learning/security/glossary/what-is-a-secure-web-gateway/)"
  - "[OWASP руководство по тестированию безопасности веб-приложений](https://owasp.org/www-project-web-security-testing-guide/)"
---
