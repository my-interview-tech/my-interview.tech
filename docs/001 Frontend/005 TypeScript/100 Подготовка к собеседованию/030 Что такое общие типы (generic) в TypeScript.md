...
info:
  - >-
    [[0016 Обобщенные и универсальные типы (generics)|Обобщенные и универсальные
    типы (generics)]]
draft: false
