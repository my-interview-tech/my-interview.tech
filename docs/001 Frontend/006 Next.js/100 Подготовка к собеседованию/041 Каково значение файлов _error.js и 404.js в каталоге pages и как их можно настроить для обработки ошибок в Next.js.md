---
uid: 0hY-f3j9bJ6RS_wEnLJd-
title: >-
  Каково значение файлов _error.js и 404.js в каталоге pages и как их можно
  настроить для обработки ошибок в Next.js?
tags:
  - NextJS
  - _error
  - _404
...
function Error({ statusCode }) {
  return (
    <div>
      ...
      {statusCode !== 404 && <p>Status Code: {statusCode}</p>}
    </div>
  );
}
...
function NotFound() {
  return (
    <div>
      ...
      <p>
        Try searching for what you need, or go back to the{" "}
        <a href="/">homepage</a>.
      </p>
    </div>
  );
