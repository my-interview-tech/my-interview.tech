---
uid: BGtyryL_i0GLu9EYK9vlC
title: >-
  Что на самом деле происходит, когда пользователь вбивает в браузер адрес
  google.com
tags:
  - "#события"
  - "#автоподстановка"
...
**Примечание:** *публикация основана на содержании репозитория [What happens when...](https://github.com/alex/what-happens-when)*
